...
#[AsCommand(name: 'foundation:ontology:openapi', description: 'Generate a basic OpenAPI 3.0 YAML from ontology manifests.')]
final class FoundationOntologyOpenapiCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($classes as $class) {
            if (!class_exists($class)) { $output->writeln("<error>Class not found:</error> $class"); continue; }
